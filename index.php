                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Đồ nữ</span>
                            <h1>Thứ sáu</h1>
                            <p>Sản phẩm thời trang nữ giảm giá với giá bán "chạm sàn": các dòng sản phẩm quần jean nữ, áo khoác, áo sơ mi nữ, công sở, giày nữ cao cấp,... sẽ được cập nhật liên trên danh mục thời trang khuyến mại của website</p>
                            <a href="./shop.php" class="primary-btn">Shop Huy_Kaisoul</a>
                        </div>
                    </div>
                    <div class="off-card">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Đồ trẻ em</span>
                            <h1>Thứ sáu</h1>
                            <p>Shop Huy Kaisoul giảm giá toàn bộ các mặt hàng đồ Trẻ em. Các bạn muốn mua hàng có thể đặt hàng online hoặc đến Shop để xem & mua trưc tiếp nhé.</p>
                            <a href="./shop.php" class="primary-btn">Shop Huy_Kaisoul</a>
                        </div>
                    </div>
                    <div class="off-card">
